...
#netletAId = "netlet://tm.uka.de/itm/SimpleArchitecture/SimpleVideoTransportNetlet\n"
#netletBId = "netlet://tm.uka.de/itm/SimpleArchitecture/SimpleVideoTransportWithFecNetlet\n"
...
class MainWindow(QtGui.QLabel):
	...
	# labels for node a and node b, the repository, and the network(s)
        nodesFont = QtGui.QFont()
        nodesFont.setPointSize(24)

	nodeALabel = QtGui.QLabel(self)
	nodeBLabel = QtGui.QLabel(self)

        networksFont = QtGui.QFont()
        networksFont.setPointSize(16)
	
	network1Label = QtGui.QLabel(self)
	network2Label = QtGui.QLabel(self)

	nodeALabel.setFont(nodesFont)
	nodeBLabel.setFont(nodesFont)
	nodeALabel.setText("Client")
	nodeBLabel.setText("Server")

	network1Label.setFont(networksFont)
	#network2Label.setFont(networksFont)
	network1Label.setText("4BC Video Evaluation Net")
	#network2Label.setText("4BC Management & Deployment Net")
	
	nodeALabel.move(50, self.height()/2 + 40)
	nodeBLabel.move(self.width() - 150, self.height()/2 + 60)

	network1Label.move(self.width()/2 - network1Label.width(), self.height()/2 - 25)
	#network2Label.move(self.width()/2 - network2Label.width() - 75, self.height()/2 + 110)

	repositoryLabel = QtGui.QLabel(self)
	repositoryLabel.setFont(networksFont)
	repositoryLabel.setText("Repository")
	repositoryLabel.move(self.width()/2 - repositoryLabel.width()/2 + 25, self.height() - repositoryLabel.height()-10) 
